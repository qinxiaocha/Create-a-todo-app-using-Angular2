        ...
        execute: function() {
            TodoService = (function () {
                function TodoService() {
                    this.todos = [new todo_model_1.TodoModel("eat"),
                        new todo_model_1.TodoModel("sleep"),
                        new todo_model_1.TodoModel("code"),
                        new todo_model_1.TodoModel("dance", "completed"),
                        new todo_model_1.TodoModel("play", "completed"),
                        new todo_model_1.TodoModel("party", "completed"),
                        new todo_model_1.TodoModel("recs"),
                        new todo_model_1.TodoModel("exercise", "completed"),
                        new todo_model_1.TodoModel("work", "completed"),
                ...
                TodoService.prototype.toggleTodo = function (todo, TodoModel) {
                    todo.toggle();
